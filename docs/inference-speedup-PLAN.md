...
13. **⭐⭐⭐ CAMPAIGN RESULT (2026-07-03): the NFE40≈NFE50 hybrid-schedule tie GENERALIZES across the full 26-protein bad_afdb26 held-out set**, not just 7AD5. Per-stage mean oracle `tm_ref_template` (N=8192, excludes 8QXI_A's pre-existing 1-corrupted-sample NaN — a leftover from the 2026-07-02 duplicate-driver incident in RAW-ARCHIVE, unrelated to this campaign): scaling8_nfe40=0.410 (n=7) vs scaling8_nfe50=0.431 (n=8); **bad_afdb26_nfe40=0.358 (n=25) vs bad_afdb26_nfe50=0.364 (n=26)** — both pairs within ~0.02-0.05, confirming NFE40 is not meaningfully worse than NFE50 at scale, i.e. the cheaper (40-step) hybrid schedule is the right deployment default. Cross-validates finding #12: the two lowest-scoring proteins in bad_afdb26 are **8TVL_A (0.190/0.184, nfe40/nfe50)** and, more moderately, 8AUC_B (0.402/0.359) — exactly the two proteins flagged with severe raw chain-break rates, confirming the sanity-check prediction. Best performer: 7E7T_B (0.731/0.889) — a genuinely strong result, not an OOD-length case. Full 58-row per-protein table in RAW-ARCHIVE.
