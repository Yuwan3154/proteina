...
python proteinfoundation/prediction_pipeline/run_prediction_pipeline.py \
    ...
    --output_dir /home/gridsan/cou/proteina/inference/inference_seq_cond_sampling_ca_dssp_extlig_no-sin-pos-emb_beta-2.5-2.0_finetune-all_v1.6_default-fold_21-seq-S25_128-eff-bs_pdb_last_045-noise/rosetta_decoys_cross_protein_analysis \
...
python proteinfoundation/prediction_pipeline/run_prediction_pipeline.py \
    ...
    --tms_col tms_single \
    --cif_dir /home/gridsan/cou/data/af2rank_single/pdb \
    --output_dir /home/gridsan/cou/proteina/inference/inference_seq_cond_sampling_ca_dssp_extlig_no-sin-pos-emb_beta-2.5-2.0_finetune-all_v1.6_default-fold_4-seq-S25_128-eff-bs_pdb_last_045-noise/rosetta_decoys_cross_protein_analysis \
