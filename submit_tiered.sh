...
# H200 eligible now; H100 at +6h (SLURM --begin gates the escalation; the 4-GPU/user cap ensures at
# most one ever runs -> no checkpoint contention). Safe to re-run anytime to backfill missing tiers.
# L40S REMOVED (2026-07-04, user directive): strictly H200/H100 only, no L40S fallback tier at all.
set -euo pipefail
